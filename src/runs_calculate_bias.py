...
my_path = "../biases/disentanglement/advbert/"
experiments = {
                # 'original_model': '../reranked/disentanglement/1405_queries/mini/original_model.trec',
                'advbert': '../reranked/advbert/advbert/NAVIDNEUTRAL-test-run.txt',
                # 'penalty_model': '../reranked/disentanglement/1405_queries/mini/penalty_model.trec',
                # 'disen_5': '../reranked/disentanglement/1405_queries/mini/disen_5.trec',
                # 'disen_2': '../reranked/215_queries/albert/disen_2.trec',
                # 'disen_3': '../reranked/215_queries/albert/disen_3.trec',
                # 'disen_4': '../reranked/215_queries/albert/disen_4.trec',
                # 'disen_5': '../reranked/215_queries/albert/disen_5.trec',
                # 'disen_6': '../reranked/215_queries/albert/disen_6.trec',
                # 'disen_7': '../reranked/215_queries/albert/disen_7.trec',
                # 'disen_8': '../reranked/215_queries/albert/disen_8.trec',
                # 'disen_9': '../reranked/215_queries/albert/disen_9.trec',
                # 'disen_10': '../reranked/215_queries/albert/disen_10.trec'
               }
